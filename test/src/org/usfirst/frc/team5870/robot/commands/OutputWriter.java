...
public class OutputWriter {
	...
	public void writeText(double forwardPower, double turnPower, 
			double intakeLPower, double intakeRPower, double elevatorPower) {
		System.out.println(forwardPower + "," + turnPower + "," + intakeLPower + 
				"," + intakeRPower + "," + elevatorPower);
		//writes to variable to text file to store motions 
		data = data.concat(forwardPower + "," + turnPower + "," + intakeLPower + 
				"," + intakeRPower + "," + elevatorPower + "\n");
	}
